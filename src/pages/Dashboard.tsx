...
import { Loader2, Users, DollarSign, Building2, UserCheck, Search, Plus, Bell, LogOut, Settings, Globe } from "lucide-react";
...
const Dashboard = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const yearlyServerCost = serverCost * 12;
      const totalCosts = totalDomainCosts + yearlyServerCost; // Domain costs + yearly server cost
      ...
      <div className="gradient-primary px-4 pt-6 pb-8 rounded-b-3xl shadow-xl">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            <Button
              onClick={() => navigate("/wordpress-updates")}
              variant="ghost"
              size="icon"
